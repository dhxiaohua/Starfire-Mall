      ...
      <div class="navbar-container">
        ...
        <nav class="navbar-nav">
          ...
          <div class="nav-dropdown" @mouseenter="showProductMenu = true" @mouseleave="showProductMenu = false">
            <router-link to="/page1" class="nav-item dropdown-trigger" :class="{ active: currentPage === 'product' }">
              产品
          ...
          <router-link to="/page2" class="nav-item" :class="{ active: currentPage === 'about' }">关于我们</router-link>
          <router-link to="/page3" class="nav-item" :class="{ active: currentPage === 'contact' }">联系我们</router-link>
        </nav>
              ...
              <div class="user-dropdown" @click="toggleDropdown">
                ...
                <div class="dropdown-menu" v-if="showDropdown">
                  <div class="dropdown-header">
                    ...
                    <span class="admin-badge" v-if="userStore.isAdmin">管理员</span>
                  </div>
    ...
    <div class="auth-modal-overlay" v-if="showAuthModal" @click.self="showAuthModal = false">
      <div class="auth-modal">
        ...
        <div class="auth-form" v-if="authMode === 'login'">
          ...
          <button @click="handleLogin" class="auth-button">登 录</button>
          <div class="auth-tip">
            <span>还没有账号？</span>
        ...
        <div class="auth-form" v-else>
          ...
          <button @click="handleRegister" class="auth-button">注 册</button>
          <div class="auth-tip">
            <span>已有账号？</span>
