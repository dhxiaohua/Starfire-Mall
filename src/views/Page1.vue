...
export default {
  ...
  setup() {
    ...
    // 广告轮播图数据
    const adBanners = [
      { image: '/images/mouse/1.jpg', title: '星火RGB电竞鼠标', desc: '16000DPI专业级游戏鼠标', category: 'mouse' },
      { image: '/images/keyboard/1.jpg', title: '星火机械键盘', desc: '青轴红轴可选，畅快敲击体验', category: 'keyboard' },
      { image: '/images/headset/1.jpg', title: '星火7.1游戏耳机', desc: '虚拟环绕声，听声辨位先发制人', category: 'headset' },
